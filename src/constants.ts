...
export const CHAT_VIEW_TYPE = 'cmpy-chat-view'
export const APPLY_VIEW_TYPE = 'cmpy-apply-view'

export const PGLITE_DB_PATH = '.cmpy_vector_db.tar.gz'
...
// Credentials are loaded from plugin settings at runtime
